...
public abstract class CommonDao {
    ...
    public <T extends BaseModel, I> void deleteById(Class cls, Integer id) throws ApplicationException {
        try {
  ...
  public <T extends BaseModel, I> T findById(Class cls, Integer id) throws ApplicationException {
        try {
            Dao<T, I> dao = getDao(cls);
