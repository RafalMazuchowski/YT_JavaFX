...
import pl.moja.biblioteczka.modelFx.*;
...
public class ListBooksController {
    ...
    @FXML
    private TableColumn<BookFx, String> decdColumn;
    ...
    void initialize() {
        ...
        this.decdColumn.setCellValueFactory(cellData -> cellData.getValue().descriptionProperty());
